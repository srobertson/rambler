...
from Rambler import failure
import Rambler.twistedlogging as log



# Rather than import these two functinos from twisted, I've copied
# there code here to avoid installing the whole twisted framework
